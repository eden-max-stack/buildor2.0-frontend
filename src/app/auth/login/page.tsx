        ...
        <div className="flex-grow border-t border-gray-300 dark:border-slate-700"></div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button 
              ...
              disabled={loading}
              className="flex items-center justify-center px-4 py-2 border rounded shadow-sm text-sm font-medium transition-colors
                         bg-white dark:bg-[#0f172a] 
                         border-gray-300 dark:border-slate-700 
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link href="/auth/register" className="font-semibold text-black dark:text-yellow-500 hover:underline">
              Register here
            </Link>
          </div>
        </div>
