          ...
          {step === 1 && (
            <>
              ...
              <form onSubmit={handleNextStep} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-700 dark:text-slate-300">Confirm Password</label>
                  <div className="relative">
                    <input
                      required
                    ...
                    <button
                      ...
                      className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 dark:text-slate-400"
                    >
                      {showConfirmPassword ? <Sun size={20} /> : <Moon size={20} />}
                    </button>
                  </div>
                </div>
                ...
                <div className="relative my-4 flex items-center">
                  ...
                  <span className="flex-shrink mx-4 text-sm text-gray-500 dark:text-slate-400">Or sign up with</span>
                  <div className="flex-grow border-t border-gray-300 dark:border-slate-700"></div>
                </div>
                ...
                <div className="mt-4 text-center text-sm">
                  ...
                  <Link href="/auth/login" className="font-semibold text-black dark:text-yellow-500 hover:underline">
                    Log in
                  </Link>
                </div>
              </form>
