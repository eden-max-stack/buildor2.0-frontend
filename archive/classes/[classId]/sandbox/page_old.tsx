...
// import { Lightbulb, Play, Eye, X, ChevronDown, ChevronUp } from "lucide-react";
...
//           .distance(200),
//       )
//       .force("charge", d3.forceMunknownBody().strength(-500))
...
//         d3
//           .drag()
//           .on("start", (event, d: unknown) => {
//             if (!event.active) simulation.alphaTarget(0.3).restart();
//             d.fx = d.x;
//             d.fy = d.y;
//           })
//           .on("drag", (event, d: unknown) => {
//             d.fx = event.x;
//             d.fy = event.y;
//           })
//           .on("end", (event, d: unknown) => {
...
//           .distance(150),
//       )
//       .force("charge", d3.forceMunknownBody().strength(-400))
//       .force("center", d3.forceCenter(width / 2, height / 2))
...
//       .append("circle")
//       .attr("r", 30)
//       .attr("fill", (d: unknown) => (d.is_definition ? "#10b981" : "#f97316"))
//       .attr("stroke", "#fff")
//       .attr("stroke-width", 2);
...
//                   Write your Python code in the editor and click
//                   `&quot;`Visualize`&quot;` to see the AST, CFG, and DFG
//                   representations.
//                 </p>
//               </div>
//             </div>
